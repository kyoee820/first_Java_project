...
//        System.out.println("count-- = " + count);
//
//        // 4. 비교 연산자 (값이 큰가 / 작은가 / 같은가 > 결과 값이 불리언으로 반환)
//        int x = 10;
//        int y = 20;
//        // x가 y보다 큰가?
//        boolean aa =  x > y;
...
//        int price = 1000;
//        int count = 3;
//        System.out.println("총 가격 : " + price * count + "원"); // 총 가격 : 3000원
//
//        // 주의사항
//        // 숫자 + 숫자 + 문자열
...
//        System.out.println("결과 : " + 1 + 2); // 결과 12
        ...
        // 문제 : 10000원으로 3500원짜리 물건을 샀을 때 거스름돈을 계산해서 출력하기
        // 가진 돈
        int money = 10000;
        int price = 3500;
        // 거스름돈 계산 - 연산자를 사용하면 됨
